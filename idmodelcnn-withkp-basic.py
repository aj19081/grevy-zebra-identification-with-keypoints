...
class SiameseNetwork(nn.Module):
    def __init__(self):
        ...
        self.cnn = nn.Sequential(
            ...
            nn.ReLU(inplace=True),
            nn.MaxPool2d(2),
            nn.Dropout(p=dropout_rate),  # Dropout after pooling
        ...
        nn.Dropout(p=dropout_rate),    # Dropout before the final FC layer
        self.fc3 = nn.Linear(100, 1)
        
        # Fully connected layer to process keypoint information
        self.fc_keypoints = nn.Linear(34, 128)
        nn.Dropout(p=dropout_rate)     # Dropout after keypoints FC layer
    ...
    def forward_once(self, x, keypoints):
        ...
        # Fusion of image features and keypoint information
